  ...
  <body>
        <h1 class="top">
          ...
          <div class="dropdown-user">
            <a class='index-link' href="<?php echo url_for("/admin/admin_index.php"); ?>">Index
              <span class='down-arrow'>&#x25BC;</span>
            </a>
            <div class="drop-content" style="right:20px;">
              <a href="<?php echo url_for("/admin/complain/complain.php"); ?>">Complain</a>
              <a href="<?php echo url_for("/admin/notice/notice.php"); ?>">Notice</a>
              <a href="<?php echo url_for("/admin/staff/staff.php"); ?>">Staff</a>
            </div>
          </div>
          <div class="dropdown-user">
            <img class="dropbtn" src="<?php echo url_for('/images/user_menu.svg')?>" alt="">
            <div class="drop-content">
              <a href="<?php echo url_for("/admin/admin/edit_admin.php"); ?>">Edit Profile</a>
              <a href="<?php echo url_for("/admin/admin/change_password.php"); ?>">Change Password</a>
              <a href="<?php echo url_for("/admin/logout.php"); ?>">Log out</a>
            </div>
          </div>
        </h1>
